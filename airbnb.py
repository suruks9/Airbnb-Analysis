...
st.set_page_config(page_title="AirBnb-Analysis by SURESH KUMAR", page_icon=":bar_chart:", layout="wide")
...
# File uploader
 ...
 if fl is not None:
    ...
    # Use BytesIO to convert the file content to a pandas DataFrame
    df = pd.read_csv(BytesIO(file_contents), encoding="ISO-8859-1")


 filename = 'C:\\Users\\My\\Downloads\\archive\\AB_NYC_2019.csv'
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"SURESH KUMAR"}')
    mail = (f'{"Mail :"}  {"suruks632@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB":   "https://github.com/suruks9",
        "LINKEDIN": "https://www.linkedin.com/in/suru-ks-99797116b/"}
